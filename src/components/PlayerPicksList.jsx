                  ...
                  {displayPred ? (
                    <div style={{ 
                      ...
                      <span style={{ 
                        ...
                        whiteSpace: 'nowrap',
                        flexShrink: 0,
                        background: displayPred.predicted_winner ? ((m.finished === 1 || liveStats) ? (underdogBonusEarned ? 'rgba(16, 185, 129, 0.25)' : (pickedUnderdog ? 'rgba(16, 185, 129, 0.25)' : 'rgba(255, 255, 255, 0.05)')) : (pickedUnderdog ? 'rgba(16, 185, 129, 0.15)' : 'rgba(255, 255, 255, 0.05)')) : 'transparent',
                        border: displayPred.predicted_winner ? ((m.finished === 1 || liveStats) ? (underdogBonusEarned ? '1px solid rgba(16, 185, 129, 0.4)' : (pickedUnderdog ? '1px solid rgba(16, 185, 129, 0.4)' : '1px solid rgba(255, 255, 255, 0.1)')) : (pickedUnderdog ? '1px solid rgba(16, 185, 129, 0.3)' : '1px solid rgba(255, 255, 255, 0.1)')) : '1px dashed rgba(255, 255, 255, 0.05)'
                      }}>
